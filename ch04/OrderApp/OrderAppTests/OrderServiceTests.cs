...
namespace OrderApp.Tests
{
    ...
    public class OrderServiceTests
    {
        ...
        public void SearchWithNameTest()
        {
            ...
            var order1 = orderService.SearchWithCommodityName(basketball.Name);
            var order2 = orderService.SearchWithCommodityName(tea.Name);
        ...
        public void SearchWithInexistingNameTest()
        {
            ...
            var order3 = orderService.SearchWithCommodityName(iPad.Name);
